...
values ('Usha', 900000.0, '2021-04-10');
insert into employee_payroll (name, salary, startDate)
values ('Sangeetha', 700000.0, '2021-09-10');
insert into employee_payroll (name, salary, startDate)
values ('Rohit', 800000.0, '2021-02-10');
insert into employee_payroll (name, salary, startDate)
values ('Jaya', 600000.0, '2021-05-10');
...
update employee_payroll set gender  = 'F' where id;
...
values ('Praveen', 'M','989656565','AP','2021-01-10');
insert into employee(name, gender, phone_number, address,startDate)
values ('Kumar', 'M','8686868686','Krishnanagar','2021-10-01');
insert into employee(name, gender, phone_number, address,startDate)
values ('Riya', 'F','9835464678','Patelnagar','2021-01-04');
insert into employee(name, gender, phone_number, address,startDate)
values ('Sowmya', 'F','6464646445','bellary','2021-04-10');
...
values ('Thrisha', 'F','778888885','USA','2021-04-16', 3000000);
insert into employee(name, gender, phone_number, address,startDate, salary)
values ('Navitha', 'F','453637475','Uk','2021-04-17', 5000000);
...
insert into employee(name, gender, phone_number, address,startDate)
values ('Thrisha', 'F','9895689865','NY','2021-04-10');
insert into payroll(basic_pay, deductions, income_tax, taxable_pay, tax, net_pay,emp_ID)
